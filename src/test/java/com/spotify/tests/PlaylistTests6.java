...
public class PlaylistTests6 {
	...
	public void shouldNotBeAbleToCreatePlayListWithoutName() {
		...
		assertSuccess(resp, 400);

		assertErrorPlayList(resp1, 400, "Missing required field: name");
	...
	public void wrongTokenTest() {
		...
		assertSuccess(resp, 401);

		assertErrorPlayList(resp1, 401, "Invalid access token");
	...
	public void accessTokenExpiredTest() {
		...
		assertErrorPlayList(resp1, 401, "The access token expired");
